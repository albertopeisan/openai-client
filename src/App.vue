      ...
      >
        <div class="flex-1 overflow-hidden">
          <div class="react-scroll-to-bottom--css-walter-79elbk h-full dark:bg-gray-800">
                        ...
                        <span
                          ...
                          ><span
                            ...
                            ><img
                              ...
                              " /></span
                          ><img
                            alt="albertopeinado96@gmail.com"
                            src="/_next/image?url=https%3A%2F%2Fs.gravatar.com%2Favatar%2F852dc48ab4827ff7e417881c2f1e3a0e%3Fs%3D480%26r%3Dpg%26d%3Dhttps%253A%252F%252Fcdn.auth0.com%252Favatars%252Fal.png&amp;w=64&amp;q=75"
                            decoding="async"
                            data-nimg="intrinsic"
                            class="rounded-sm"
                            srcset="
                              /_next/image?url=https%3A%2F%2Fs.gravatar.com%2Favatar%2F852dc48ab4827ff7e417881c2f1e3a0e%3Fs%3D480%26r%3Dpg%26d%3Dhttps%253A%252F%252Fcdn.auth0.com%252Favatars%252Fal.png&amp;w=32&amp;q=75 1x,
                              /_next/image?url=https%3A%2F%2Fs.gravatar.com%2Favatar%2F852dc48ab4827ff7e417881c2f1e3a0e%3Fs%3D480%26r%3Dpg%26d%3Dhttps%253A%252F%252Fcdn.auth0.com%252Favatars%252Fal.png&amp;w=64&amp;q=75 2x
                            "
                            style="
                              position: absolute;
                              inset: 0px;
                      ...
                      <div class="flex flex-grow flex-col gap-3">
                        ...
                        >
                          <div class="markdown prose w-full break-words dark:prose-invert dark">
                            <p>
                              Hello there! Is there anything you would like to ask or discuss? I'm
            ...
            <button
              class="react-scroll-to-bottom--css-wsxdy-1tj0vk3 scroll-convo"
              type="button"
            ></button>
          </div>
        </div>
        ...
        >
          ...
          >
            <div class="relative flex h-full flex-1 md:flex-col">
              <div
                class="hidden md:flex ml-1 md:w-full md:m-auto md:mb-2 gap-0 md:gap-2 justify-center"
              >
              ...
              <div
                class="flex ml-1 md:hidden md:w-full md:m-auto md:mb-2 gap-0 md:gap-2 justify-center"
              >
                <button class="btn relative btn-neutral border-0 md:border">
                  <div class="flex w-full items-center justify-center gap-2">
                    <svg
              ...
              <div class="flex flex-col gap-2 text-gray-100 text-sm">
                <a
                  ...
                  <div class="flex-1 text-ellipsis max-h-5 overflow-hidden break-all relative">
                    Deploying React Website on AWS
                    <div
