<template>
  <div v-if="isOpen">
    <div class="relative z-40 md:hidden" id="headlessui-dialog-:r2:" role="dialog" aria-modal="true"
        ...
        <div class="relative flex w-full max-w-xs flex-1 flex-col bg-gray-900 translate-x-0"
          ...
          <div class="absolute top-0 right-0 -mr-12 pt-2 opacity-100">
            <button @click="toggleSidebar" type="button"
              ...
              tabindex="0">
              <span class="sr-only">Close sidebar</span><svg stroke="currentColor" fill="none" stroke-width="1.5"
                viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" class="h-6 w-6 text-white" height="1em"
              ...
              <a
                ...
                class="flex py-3 px-3 items-center gap-3 rounded-md hover:bg-gray-500/10 transition-colors duration-200 text-white cursor-pointer text-sm"><span
                  class="flex w-full flex-row justify-between"><span class="gold-new-button flex items-center gap-3"><svg
                    ...
                    </svg>Upgrade to Plus</span></span></a><a
