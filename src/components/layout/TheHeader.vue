<template>
  <header
    class="sticky top-0 z-10 flex h-16 w-full shrink-0 items-center border-b bg-gray-50 dark:bg-gray-800 border-gray-300 dark:border-gray-700"
  >
    <div class="flex items-center w-full px-6 sm:px-8 md:px-10 lg:px-12">
      <button
        @click="toggleSiderBar"
        class="shrink-0 flex items-center justify-center text-gray-700 rounded-full outline-none hover:bg-gray-500/5 focus:bg-primary-500/10 lg:mr-4 rtl:lg:mr-0 rtl:lg:ml-4 lg:hidden"
      >
  ...
  >
    <header
      class="sidebar-header border-b h-16 shrink-0 flex items-center justify-center relative dark:border-gray-700"
    >
      <div class="flex items-center justify-between w-full px-6 sm:px-8 md:px-10 lg:px-12">
        <div>LOGO</div>
        <button
          @click="toggleSiderBar"
          class="shrink-0 flex items-center justify-center text-gray-700 rounded-full outline-none hover:bg-gray-500/5 focus:bg-primary-500/10 lg:mr-4 rtl:lg:mr-0 rtl:lg:ml-4 lg:hidden"
    ...
    <div
      class="flex flex-col justify-between w-full h-full p-3 w-60 dark:bg-gray-900 dark:text-gray-100"
    >
      <div class="space-y-3">
        <div class="flex-1">
          <ul class="pt-2 pb-4 space-y-1 text-sm">
            <li class="rounded-sm">
              ...
              >
                <font-awesome-icon :icon="['fas', 'house']" class="w-6 h-6" />
                <span>Inicio</span>
              </RouterLink>
            </li>
            <li class="rounded-sm">
              <RouterLink
                ...
                class="flex items-center p-2 space-x-3 rounded-md"
              >
                <font-awesome-icon :icon="['fas', 'comments']" class="w-6 h-6" />
                <span>Chatbot</span>
              </RouterLink>
            </li>
            <li class="rounded-sm">
              <RouterLink
                ...
                class="flex items-center p-2 space-x-3 rounded-md"
              >
                <font-awesome-icon :icon="['fas', 'circle-question']" class="w-6 h-6" />
